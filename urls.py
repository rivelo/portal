...
urlpatterns = [ #patterns('',
    ...
    url(r'^100mile/$', event_calendar_views.show_event, {'id': 27} , name='event-show'),
    ...
    url(r'^rider/checkpoint/result/add/package/$', event_calendar_views.result_checkpoint_add_package, name='event-checkpoint-result-add-package'),
    ...
    url(r'^rider/regstatus/$', event_calendar_views.rider_regstatus),
