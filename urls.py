...
urlpatterns = patterns('',
    ...
    url(r'^news/result/(?P<year>\d+)/$', 'portal.event_calendar.views.year_results', name='year-result' ),
    ...
    url(r'^calendar/year/(?P<year>\d+)/$', 'portal.event_calendar.views.calendar_filter', name='calendar-year'),
...
#    url(r'^wheel/size/add/$', 'portal.tools.views.add_wheelsize' ),
    ...
    url(r'^bicycles/$', 'portal.event_calendar.views.shop_bicycle_company', name='bicycle-company'),
    url(r'^bicycles/(?P<id>\d+)/brand/$', 'portal.event_calendar.views.shop_bicycle_brand', name='bicycle-list-bybrand'),
    url(r'^bicycles/(?P<id>\d+)/model/$', 'portal.event_calendar.views.shop_bicycle', name='bicycle-show'),
